...
#
# Created: Thu Oct 29 17:58:54 2015
...
"}"))
        ...
        self.file_export = QtGui.QLineEdit(self.centralwidget)
        self.file_export.setObjectName(_fromUtf8("file_export"))
        self.Layout_controls2.addWidget(self.file_export, 0, 1, 1, 1)
        self.gridLayout.addLayout(self.Layout_controls2, 3, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "eHealth", None))
        self.pButton_Start.setText(_translate("MainWindow", "Start", None))
        self.pButton_Stop.setText(_translate("MainWindow", "Stop", None))
        self.chBox_export.setText(_translate("MainWindow", "Export to CSV              Session Name:", None))
        self.file_export.setText(_translate("MainWindow", "session", None))
